...
\section{Contexto}
No presente momento de desenvolvimento deste trabalho, observa-se uma grande procura por avaliações neuropsicológicas: entre 1989 e julho de 2025, 69,6\% dos diagnósticos de autismo foram em 2020 \cite{Mab2026}. A principal causa para essa busca reside na maior divulgação do tema em mídias tradicionais e digitas, especialmente em discussões relacionadas ao Transtorno do Espectro Autista (TEA) e outros transtornos do neurodesenvolvimento.
