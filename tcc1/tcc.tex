...
\section{Fundamentos}
Aprofunde os conceitos técnicos que serão utilizados na solução proposta. Diferen-temente do referencial teórico (que apresenta conceitos gerais), os fundamentos devem detalhar as tecnologias, algoritmos, frameworks ou metodologias específicas que serão empregados no desenvolvimento.
\\Por exemplo:
\begin{itemize}
	...
	\item Se o trabalho envolve desenvolvimento de software, descreva as tecnologias (lingua-gens, frameworks, bancos de dados);
