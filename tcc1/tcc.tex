...
Nesta seção, descreveremos a hipótese proposta neste trabalho.
...
\subsection{Trabalho 2: Estudo de caso da aplicação de simulação de eventos discretos num processo de radioterapia}
