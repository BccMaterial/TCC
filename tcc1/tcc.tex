...
Lean healthcare é a variação da metodologia Lean voltada para área de saúde, é segundo o livro \citeonline{Graban2013} um conjunto de ferramentas, um sistema de gestão e uma filosofia que podem mudar a forma pela qual os hospitais são organizados e administrados. A metodologia promove a redução dos erros e do tempo de espera proporcionando melhora para o paciente além disso coloca valor no profissional que será o recurso escasso otimizando o uso de tal recurso, 2 fatores muito importantes associados ao Lean é a melhoria continua ("kaizen" em japonês) e o respeito, ambos vem da filosofia japonesa já que o Lean é originário do método da Toyota. quando falamos de respeito, falamos de respeito ao paciente, respeito ao tempo e respeito à presença do paciente, por isso é importante na metodologia dado o fato que queremos otimizar o tempo e por consequência respeitando o paciente.

A melhoria contíuna ou "kaizen" é citado no livro \citeonline{Graban2013}. Esses esforços de melhoria têm como foco muitas vezes a redução do desperdício existente no tratamento do paciente ou no trabalho das pessoas. E quando é falado sobre desperdício, é relacionado ao termo japonês "muda", e nesse contexto é toda e qualquer atividade que não beneficie o paciente ou não agilize o tratamento ou diagnóstico.
