...
Pesquisa Operacional é um ramo da matemática aplicada composta por diversas técnicas de outras ciências matemáticas, como modelagem, estatística e otimização, com o fim de contribuir na tomada de decisões e gerenciamento, encontrando soluções ótimas ou quase-ótimas \cite{Lieberman2010}. Dentre essas técnicas, utilizaremos Simulação de Eventos e Teoria das Filas, ferramentas que serão essenciais no contexto do nosso problema para a reprodução de cenários e a construção de modelos. 
