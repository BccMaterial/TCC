...
Assim sendo, este trabalho se justifica a partir de sua relevância social, acadêmica e prática. Atrasos ou ausências de diagnósticos podem resultar impactos significativos na vida dos pacientes, especialmente em um contexto escolar, acadêmico, profissional e social. Tanto crianças quanto adultos estão vulneráveis a esses impactos, tornando difícil o acesso a intervenções adequadas, adaptações necessárias e acompanhamento terapêutico.
...
Os autores propõem como solução o uso de simulação de eventos discretos nos softwares SIMUL8 e ARENA, a partir de amostra de dados de pacientes da clínica que foram analisados e tratados. Com isso, foi possível analisar as distribuições e as expressões que representam o tempo gasto em cada etapa do processo de radioterapia, para assim gerar um modelo computacional no qual foi validado com teste de Lavene, além de ser comparado com o sistema real, demonstrando que ambos os sistemas não possuem diferenças estatísticas significativas.
